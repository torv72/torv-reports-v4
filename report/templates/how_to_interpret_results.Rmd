...
```{r how_to_header, out.width=if(knitr::is_latex_output()) "5.8in" else "900px", out.height=if(knitr::is_latex_output()) "0.44in" else NULL}
...
\vspace{6mm}
\noindent{\large\textbf{\textcolor{torvgray}{How and why MLSN works}}}
...
\vspace{6mm}
\noindent{\large\textbf{\textcolor{torvgray}{Why MLSN is needed}}}
...
\vspace{6mm}
\noindent{\large\textbf{\textcolor{torvgray}{Frequently asked questions}}}

\vspace{4mm}
\noindent{\textbf{\textcolor{torvgray}{How do I know the nutrients are available?}}}
...
\vspace{4mm}
\noindent{\textbf{\textcolor{torvgray}{MLSN guideline, target level or minimum level?}}}
...
\vspace{4mm}
\noindent{\textbf{\textcolor{torvgray}{Seriously, the same minimum for every grass, soil, and location? No regional customization?}}}
...
\vspace{4mm}
\noindent{\textbf{\textcolor{torvgray}{How is this different than conventional soil test interpretation?}}}
...
\vspace{4mm}
\noindent{\textbf{\textcolor{torvgray}{What about micronutrients?}}}
...
\vspace{4mm}
\noindent{\textbf{\textcolor{torvgray}{What about salinity?}}}
