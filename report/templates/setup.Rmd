...
if(is_installed) {
  ...
  if(typeface == "Georama") {
    ...
    message("Using a non-corporate typeface as specified. Note that only the regular and bold variants are used.\nTo use the corporate typeface, please install all font files from the folder report/assets/fonts/ and use the default setting for the .typeface argument.")
