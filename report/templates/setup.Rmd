...
make_trendline_legend <- function(main_color, stat = "average", draw_beeswarm = input_params$beeswarm) {
  ...
  ggplot(legend_plot_data,
    ...
    annotate(
      ...
      label = paste(str_to_title(input_params$om_stats), "measurement"),
...
trend_legend <- make_trendline_legend(main_color = "grey30", draw_beeswarm = input_params$beeswarm)

ggsave(here(root_figure_location, "trendlines", "trend_plot_legend.png"),
       trend_legend, width = 2.5, height = 2, bg = "#ffffff", dpi = 300)
