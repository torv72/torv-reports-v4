...
if(is_installed) {
  ...
  if(typeface == "Georama") {
   ...
   systemfonts::register_variant(
    ...
    message("\n❗ Using a non-corporate typeface as specificed. Note that only regular and bold variants are used. To use the corporate typeface, please install the typeface on your system and then restart your R session.")
