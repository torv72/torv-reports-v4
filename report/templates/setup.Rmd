...
if(is_installed) {
  ...
  typeface_condensed <<- paste(typeface, "Condensed")  # Changed from SemiCondensed
  typeface_medium <<- paste(typeface, "Medium")
  typeface_ultrabold <<- paste(typeface, "ExtraBold")  # Changed from ultrabold
  typeface_condensed_medium <<- paste(typeface, "Condensed Medium")
  ...
  systemfonts::register_variant(
    ...
    weight = "bold"  # Changed from ultrabold
  )
