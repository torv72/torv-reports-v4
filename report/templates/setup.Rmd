...
make_trendline_legend <- function(main_color = "grey30", 
  ...
  ggplot(legend_plot_data,
    ...
    geom_label(aes(x = lubridate::as_date("2021-01-01"), y = torv_avg, label = paste(label_stat, stat)), 
      family = typeface, color = color_stat, size = 7/.pt, label.size = 0, stat = "unique"
    ) +
