...
make_trendline_legend <- function(main_color, average_label = paste("Historic", input_params$om_stats), draw_beeswarm = input_params$beeswarm) {
  ...
  ggplot(legend_plot_data,
    ...
    geom_label(aes(x = lubridate::as_date("2021-01-01"), y = torv_avg, label = average_label), 
