...
if(is_installed) {
  typeface_tabular <<- typeface#paste(typeface, "Tabular") ## same now as Georama already has tabular numbers
...
theme_update(
  ...
  plot.title = element_text(family = typeface_medium, size = base_size * .67),
  strip.text = element_text(family = typeface_medium, size = base_size * .67),
