...
```{r, results='asis'}
if(html) {
  cat("Each element is plotted against its MLSN threshold, scaled to nitrogen input and growth potential. A <b style='color:#698960;'>green dot</b> meets the requirement; <b style='color:#d08c47;'>orange</b> falls within 1%; <b style='color:#a65d57;'>red</b> indicates a deficit.")
} else {
  cat("Each element is plotted against its MLSN threshold, scaled to nitrogen input and growth potential. A \\textcolor{successgreen}{green dot} meets the requirement; \\textcolor{warningorange}{orange} falls within 1\\%; \\textcolor{deficitred}{red} indicates a deficit.")
}
```
