...
<details><summary>Required element per area (lbs. per 1000 sq.ft.)</summary>
...
filter(fertilizer_table_all, sample_description_number_1 == "{{sample_description_number_1}}") %>%
  ...
  flextable::font(fontname = typeface, 
                  part = "all")
...
<details><summary>Mean measurements and recommendations</summary>
