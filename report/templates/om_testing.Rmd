...
make_om_plot <- function(plot_measurement_name, plot_depth, draw_beeswarm = input_params$beeswarm) {
  ...
  om_plot <- 
    ...
    ggiraph::geom_hline_interactive(
      aes(yintercept = torv_avg, data_id = 1, tooltip = paste0("<span style='font-size:12pt;'>Historic ", input_params$om_stats, ":</span><br><b>", round(torv_avg, 2), "%</b>")),
...
om_tbl <- om_longitudinal_table_reduced %>%
  ...
  color(i = 1, color = torv_color, part = "header") %>% 
  # { if ("0-2 cm" %in% depths)
  #   color(
  #     color = function(x) {
