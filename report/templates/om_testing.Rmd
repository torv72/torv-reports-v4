...
tooltip_css_om <- paste0("background-color:white;padding:8px;border-radius:5px;border-width:2px;color:black;border-style:solid;border-color:", torv_color, ";line-height:1.15;font-family:", typeface_tabular, ";font-size:1.4em;")
...
if (html) {
  ggiraph::girafe(
    ...
    options = list(
      opts_tooltip = ggiraph::opts_tooltip(css = tooltip_css_om, opacity = 1, use_fill = FALSE, offx = 10, offy = 10),
