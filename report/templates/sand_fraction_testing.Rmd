...
```{r, results='asis'}
if(html) {
  cat("- <b style='color:#0AA67B;'>Green dots</b> dots represent samples that meet USGA recommendations.\n")
  cat("- <b style='color:#B22222;'>Red dots</b> represent samples that do not satisfy USGA recommendations.\n")
