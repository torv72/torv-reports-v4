...
if(is_installed) {
  ...
  message("Using system default font as the corporate font is not installed on your system. Please install Lato on your system and then restart your R session: https://fonts.google.com/specimen/Lato")
  font_main <- ""
} 
