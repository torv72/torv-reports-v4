...
````{r get-types, results='asis', warning=FALSE, message=NA}
...
```{r soil-results, results='asis', warning=FALSE, message=FALSE}
...
```{r om-results, results='asis', warning=FALSE, message=FALSE}
...
```{r water-results, results='asis', warning=FALSE, message=FALSE}
