...
header-includes:
  ...
  - \pagestyle{fancy}
  - \fancyhf{}
  - \fancyhead[L]{\textcolor{gray}{Agronomic Report -- \today}}
...
```{r logo-header, out.width=if(knitr::is_latex_output()) "3.5in" else "35%", fig.align='center'}
...
cat(
  "\\thispagestyle{empty}",
  "\\bigskip  \\bigskip  \\begin{center}\\Large \\textbf{Agronomic Report}\\par\\large ",
...
\AddToShipoutPictureFG{%
  \AtPageCenter{%
    \makebox[0pt]{%
      \transparent{0.07}\includegraphics[width=4in]{torv-logo.png}%
    }%
  }%
}
```
