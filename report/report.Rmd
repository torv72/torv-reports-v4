...
```{r turf-growth-rds-html, eval=length(soil_types) > 0, fig.height=3.5, eval=html}
#readRDS(here("report", "figures", "growth_potential_plot.Rds"))
girafe(ggobj = growth_potential_plot)
```

```{r turf-growth-plot-pdf, eval=length(soil_types) > 0, fig.height=4.1, out.width="100%", eval=!html}
