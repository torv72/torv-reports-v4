...
header-includes:
  - \usepackage{xcolor}
  - \definecolor{deficitred}{HTML}{B22222}
  - \definecolor{warningorange}{HTML}{E3AA04}
  - \definecolor{successgreen}{HTML}{0AA67B}
...
\AddToShipoutPictureFG{%
  \AtPageCenter{%
    \makebox[0pt]{%
      \transparent{0.2}\includegraphics[width=4in]{/Users/ericfoerster/Desktop/torv-reports v4/report/assets/torv-logo.png}%
    }%
  }%
}
```
