...
#   " of the xyz survey conducted on ", 
#   format(as_date(input_params$date_sample_submitted), "%Y, %B %d"), 
#   " by Eric Foerster. All charts in the report are interactive, which means that you can hover over chart elements to see more details."
# )

cat("<h1 style='color:black;'>Interactive Agronomic Survey Report</h1>",
   "<h2 style='color:black;'>", input_params$site_name, "</h2>",
  "**Date:** ",
  format(as_date(input_params$date_sample_submitted), "%Y, %B %d"),
  "<br>**Consultant:** Eric Foerster<br><br>",
  "
...
2. **Easy Navigation:** Use the table of contents to jump to specific sections.
